...
//       profiles: NEW SF11/CR4-8 | OLD SF9/CR4-7 (both sync 0x12, CRC on)
...
// Must match PAYLOAD/include/New/Config.hpp. Payload reverted from the
// 2450/SF12 trial back to this profile.
...
static constexpr Profile PROFILES[] = {
  { "NEW SF11/CR4-8", 11, 8 },   // current payload profile
  { "OLD SF9/CR4-7",   9, 7 },   // adapter-firmware default
};
...
static void printStatus() {
  ...
  Serial.println("  2400 MHz / BW 812.5 / high-sens ON");
