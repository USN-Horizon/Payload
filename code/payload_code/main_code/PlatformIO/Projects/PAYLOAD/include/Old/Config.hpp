...
#include <Wire.h>         // I2C bus support for sensors.
  ...
  #include <mavlink/v2.0/common/mavlink.h>  // MAVLink common dialect (heartbeat, scaled_imu, etc.).
...
constexpr uint16_t LORA_TEMP_SENSOR       = 501;  // There os a LoRa temp sensor on
constexpr uint16_t LORA_VOLT_CHANGER      = 502;  // There is a LoRa Volt changer that can deside how strong the signal from the lora is Up to (3V or 3.3V I think)
