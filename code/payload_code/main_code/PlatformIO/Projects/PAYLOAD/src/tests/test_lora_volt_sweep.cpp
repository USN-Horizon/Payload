...
static constexpr int PIN_CXT      = 11;   // IF15 antenna-switch control (NOT DIO1)
static constexpr int PIN_CRX      = 12;   // IF16 antenna-switch control
...
// DIO1 is RADIOLIB_NC: GPIO11 is the antenna-switch CXT line on this board,
// not the chip's DIO1 (see test_lora_rfswitch_burst / LoraTx::begin).
...
void setup() {
    ...
    delay(10);
    // Antenna switch to the true TX state (CXT=HIGH, CrX=LOW), found by
    // test_lora_rfswitch_burst with the PA biased (state 2, ~-29 dBm).
