...
// BW 203.125 kHz, SF11, CR 4/8, CRC on, whitening on. MUST match the transmitter.
//
...
static constexpr float   RF_BW_KHZ   = 203.125f;  // matches production (Config.hpp)
...
void setup() {
    ...
    result("radio config (2400/203.125/SF11/CR4-8, CRC+whiten)", cfg);
