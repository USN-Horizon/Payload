...
//
// Verifies that the interrupt-driven pulse input on GPIO 17 works.
//
// PASS criteria:
...
// Check: 5 V supply to Geiger module, signal wire on GPIO 17.
//
...
static constexpr int     GEIGER_PIN = 17;
...
void setup() {
    ...
    result("Interrupt attached on GPIO 17", true);
    ...
    if (count > 0) {
        ...
        Serial.println("         Check: 5 V to Geiger module, signal on GPIO 17.");
